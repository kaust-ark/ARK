...
أسرع طريقة لتجربته هي النسخة المستضافة على **[idea2paper.org](https://idea2paper.org/)** — سجّل الدخول ببريدك الإلكتروني، وأضف مفتاح [OpenRouter](https://openrouter.ai/keys) واحداً، ثم انطلق. ورقة كاملة بنموذج اقتصادي مثل DeepSeek تكلّف عادةً **نحو 5 دولارات من رصيد API الخاص بك**. أما الاستضافة الذاتية فتثبيتها بسطر واحد (أدناه).

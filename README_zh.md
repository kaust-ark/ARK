...
<p align="center">
<img src="https://idea2paper.org/assets/paper-example.png" alt="MMA 论文" width="480">
<br>
...
| **Reviewer** | 按会议标准评分，生成改进任务；检查实验与提案一致性 |
| **Planner** | 将审稿意见转化为优先级行动计划；验证实验一致性 |
| **Writer** | 撰写和打磨 LaTeX 章节，引用经 DBLP 验证 |
| **Experimenter** | 设计实验、提交 Slurm 任务、分析结果；多提供商 API 回退 |
